...
with st.container():
    ...
    with col3:
        ...
        st.bar_chart(preserve_sorting_df(movies_statistics.get("watching_counts"), cat_column='genre'), x='genre', y='count', height = 320)
...
with st.container():
    ...
    with col5:
        ...
        st.bar_chart(movies_statistics.get("movies_ratings_distribution"), x='rating', y='count', height = 280)
    with col6:
